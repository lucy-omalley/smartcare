...
const SupportingFeaturesSection = dynamic(
  ...
  { loading: () => <section className="min-h-[100px]" aria-hidden /> }
);
...
/** Pre-sign-in marketing homepage — focused hero + scrollable proof sections. */
export function LandingPageV2() {
  return (
    <div className="flex min-h-screen flex-col landing-v2 scroll-smooth">
      <LandingNavV2 />
