...
export default function FounderPostersPage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h2 className="text-xl font-bold">Routine Poster Designer</h2>
        <p className="text-sm text-muted-foreground">Printable visual routines — last 30 days where noted</p>
      </header>
